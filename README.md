...
2.  **Web Research:** For each query, it uses the LLM with the Google Search API to find relevant web pages.
...
- [Anthropic Claude](https://www.anthropic.com/claude) (or any Anthropic-compatible model) - LLM for query generation, reflection, and answer synthesis.
